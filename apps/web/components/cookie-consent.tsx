...
const APOLLO_INBOUND_ID = process.env.NEXT_PUBLIC_APOLLO_INBOUND_ID || '';

function loadApolloScripts() {
  // Tracking is opt-in via env and disabled in the public showcase.
  if (!APOLLO_TRACKER_ID || !APOLLO_INBOUND_ID) return;
