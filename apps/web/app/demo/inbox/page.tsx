  ...
  return (
    <>
      ...
      <main className="flex-1 min-w-0 flex flex-col bg-bg">
        <TopBar title={t('Inbox')} subtitle={t('Unified communication · 3 unread')} />
            ...
            <div className="flex-1 overflow-y-auto px-6 py-2 flex flex-col gap-5">
              ...
              <div className="max-w-[520px] self-end">
                <div className="flex items-center gap-2 mb-1.5 justify-end">
                  <span className="text-[10px] text-fg4">{t('just now')}</span>
                  <span className="text-[12px] font-medium text-fg">
                    Sarah Vogel
                  </span>
                ...
                <div className="bg-accent text-bg rounded-xl px-4 py-3">
                  <p className="text-[13px] leading-relaxed">
                    {t('Thanks for reaching out — pulling up the details now and will get right back to you.')}
                  </p>
                </div>
              </div>
            </div>
