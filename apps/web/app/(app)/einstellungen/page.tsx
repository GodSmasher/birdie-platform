            ...
            <div className="flex flex-col gap-4 max-w-[820px]">
              <Card className="p-5 flex flex-col gap-4 opacity-75">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex flex-col"><span className="text-sm font-medium text-fg">Alex Rivera</span><span className="text-xs text-fg2">SunPeak Solar Systems · Administrator</span></div>
                </div>
              </Card>
          ...
          <Card className="p-5 flex flex-col gap-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-fg2">SunPeak Solar Systems · Administrator</span>
              </div>
            </div>
            <div className="grid grid-cols-2 gap-3 text-xs">
              <Row k="Company" v="SunPeak Solar Systems" />
