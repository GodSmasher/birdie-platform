...
// HTML email shell — matches the Brevo templates (logo, white card, footer)
const INSTALLER_LOGO = 'https://sunpeak-solar.example/logo.png';
...
<img src="${INSTALLER_LOGO}" width="180" alt="SunPeak Solar">
</td>
</tr>
<tr>
<td>
...
SunPeak Solar · Musterstraße 1 · 10115 Berlin<br>
Telefon: 0341 92881147 ·
<a href="https://sunpeak-solar.example">sunpeak-solar.example</a>
</p>
</td>
</tr>
</table>
...
<p>Vielen Dank und freundliche Grüße<br><strong>SunPeak Solar</strong></p>`),
...
<p>Freundliche Grüße<br><strong>SunPeak Solar</strong></p>`),
    textPlain: `Guten Tag {{kunde_name}},
...
<p><strong>SunPeak Solar</strong></p>`),
    textPlain: `Guten Tag {{kunde_name}},
