...
const leadRaw: [string, string, string, string, string, string, number, number, string, LeadStatus][] = [
  ['Marcus Webb','marcus.webb@example.com','(615) 555-0142','Aurora Solar','Nashville, TN','Residential',88,0,'2h ago','New'],
  ['Priya Shah','p.shah@example.com','(512) 555-0198','Referral','Austin, TX','Residential',74,1,'5h ago','Contacted'],
  ['Trellis HOA','ops@trellishoa.example','(602) 555-0110','Website','Phoenix, AZ','Commercial',92,2,'1d ago','Qualified'],
  ['Robert Osei','rosei@example.com','(303) 555-0176','Aurora Solar','Denver, CO','Residential',81,0,'1d ago','Contacted'],
  ['Karen Alvarez','kalvarez@example.com','(469) 555-0133','Google Ads','Dallas, TX','Residential',67,3,'2d ago','New'],
  ['The Nguyens','nguyen.fam@example.com','(408) 555-0155','Referral','San Jose, CA','Residential',79,1,'2d ago','Qualified'],
  ['Brian Carter','bcarter@example.com','(704) 555-0188','Website','Charlotte, NC','Residential',58,2,'3d ago','Unresponsive'],
  ['Diane Meyer','diane.meyer@example.com','(512) 555-0121','Aurora Solar','Austin, TX','Residential',85,4,'3d ago','Qualified'],
  ['Sunset Storage LLC','fac@sunsetstorage.example','(480) 555-0144','Website','Mesa, AZ','Commercial',90,2,'4d ago','Contacted'],
  ['Tyler Brooks','tbrooks@example.com','(615) 555-0167','Google Ads','Franklin, TN','Residential',49,0,'4d ago','Disqualified'],
  ['Amara Okafor','amara.o@example.com','(770) 555-0102','Referral','Atlanta, GA','Residential',82,3,'5d ago','Contacted'],
  ['Grant Mills','gmills@example.com','(801) 555-0190','Aurora Solar','Salt Lake City, UT','Residential',71,1,'5d ago','New'],
  ['Rivera Farms','office@riverafarms.example','(559) 555-0119','Website','Fresno, CA','Commercial',86,4,'6d ago','Qualified'],
  ['Hannah Lang','hlang@example.com','(503) 555-0173','Google Ads','Portland, OR','Residential',63,2,'6d ago','Contacted'],
  ['Devon Pratt','dpratt@example.com','(210) 555-0128','Aurora Solar','San Antonio, TX','Residential',77,0,'1w ago','New'],
  ['Olivia Stone','ostone@example.com','(305) 555-0161','Referral','Miami, FL','Residential',69,3,'1w ago','Unresponsive'],
  ['Northgate Church','admin@northgate.example','(919) 555-0135','Website','Raleigh, NC','Commercial',88,1,'1w ago','Qualified'],
  ['Jason Fields','jfields@example.com','(720) 555-0147','Google Ads','Aurora, CO','Residential',55,4,'1w ago','Contacted'],
  ['Maya Cohen','maya.cohen@example.com','(602) 555-0182','Aurora Solar','Scottsdale, AZ','Residential',80,2,'8d ago','New'],
  ['Ellis Ward','eward@example.com','(615) 555-0159','Referral','Nashville, TN','Residential',73,0,'9d ago','Contacted'],
  ['Coastal Dental','front@coastaldental.example','(843) 555-0113','Website','Charleston, SC','Commercial',84,3,'9d ago','Qualified'],
  ['Nina Petrov','npetrov@example.com','(408) 555-0126','Google Ads','Sunnyvale, CA','Residential',61,1,'10d ago','Unresponsive'],
  ['Derek Hughes','dhughes@example.com','(214) 555-0170','Aurora Solar','Plano, TX','Residential',76,4,'11d ago','New'],
  ['Wade Foster','wfoster@example.com','(480) 555-0104','Referral','Tempe, AZ','Residential',52,2,'12d ago','Disqualified'],
  ['Sofia Marino','smarino@example.com','(303) 555-0193','Website','Boulder, CO','Residential',87,0,'13d ago','Qualified'],
  ['Aiden Clarke','aclarke@example.com','(615) 555-0138','Google Ads','Murfreesboro, TN','Residential',66,3,'2w ago','Contacted'],
];
...
export const settingsTeam = [
  { name: 'Sarah Vogel', email: 'sarah@sunpeak-solar.example', role: 'Admin', init: 'SV' },
  { name: 'Marcus Lee', email: 'marcus@sunpeak-solar.example', role: 'Manager', init: 'ML' },
  { name: 'Elena Ruiz', email: 'elena@sunpeak-solar.example', role: 'Sales', init: 'ER' },
  { name: 'Tom Becker', email: 'tom@sunpeak-solar.example', role: 'Sales', init: 'TB' },
  { name: 'Mike Torres', email: 'mike@sunpeak-solar.example', role: 'Installer', init: 'MT' },
  { name: 'Dana Kim', email: 'dana@sunpeak-solar.example', role: 'Installer', init: 'DK' },
];
