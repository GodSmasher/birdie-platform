...
const BASE = (process.env.BASE_URL ?? 'https://birdie-platform-nine.vercel.app').replace(/\/$/, '')
...
const TOUR = [
  { path: '/demo/dashboard', linger: 2600, scroll: 0 },
  { path: '/demo/pipeline', linger: 2400, scroll: 0 },
  { path: '/demo/interconnection', linger: 2400, scroll: 300 },
  { path: '/demo/schedule', linger: 2200, scroll: 0 },
  { path: '/demo/lang?to=de&next=/demo/dashboard', linger: 2600, scroll: 0 },
  { path: '/demo/workflows', linger: 2400, scroll: 300 },
]
...
// The marketing site shows a cookie banner on first visit; the demo tour should not.
