...
const INSTALLER = {
  company: process.env.INSTALLER_COMPANY || 'SunPeak Solar GmbH',
...
export async function fillE2(project: ProjectData, customerName: string): Promise<Uint8Array | null> {
  ...
  // Netzanschluss-Phasen — Installer: immer 3-phasig (bestätigt 2026-05-26)
