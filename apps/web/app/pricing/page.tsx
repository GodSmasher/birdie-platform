  ...
  return (
    <div className="min-h-screen bg-[#08080c] text-white">
      ...
      <nav className="fixed top-0 w-full z-50 bg-[#08080c]/80 backdrop-blur-2xl border-b border-white/[0.04]">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="https://cal.example/birdie-intro" target="_blank" rel="noopener noreferrer" className="px-5 py-2.5 bg-[#FACC15] text-[#0a0a0f] rounded-full text-[13px] font-bold hover:bg-[#fde047] hover:scale-105 active:scale-95 transition-all shadow-lg shadow-[#FACC15]/20">
              Book a Demo
            </Link>
          </div>
        </div>
          ...
          {tiers.map((tier, i) => {
            ...
            return (
              ...
              >
                ...
                <Link
                  href="https://cal.example/birdie-intro" target="_blank" rel="noopener noreferrer"
      ...
      <section className="max-w-2xl mx-auto px-6 pb-20 text-center">
        ...
        <Link href="https://cal.example/birdie-intro" target="_blank" rel="noopener noreferrer" className="inline-block px-8 py-3.5 bg-[#FACC15] text-[#0a0a0f] rounded-full text-[14px] font-bold hover:bg-[#fde047] hover:scale-105 active:scale-95 transition-all shadow-lg shadow-[#FACC15]/20">
          Book a Free Demo →
        </Link>
      </section>
