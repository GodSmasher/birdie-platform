...
export const DEMO_MAILBOX = {
  configured: true,
  error: undefined as string | undefined,
  account: 'team@sunpeak-solar.example',
  unread: 7,
  messagesTotal: 2847,
  recent: [
    { id: 'm1', from: 'permits@utility.example', subject: 'Interconnection Approval — Rodriguez (4521 Oak Lane)', snippet: 'Your application has been approved. Please proceed with installation scheduling...', date: '2026-06-16T09:42:00Z' },
    ...
    { id: 'm3', from: 'noreply@aurora-solar.example', subject: 'Design Complete — Henderson Project', snippet: 'Your solar design for 882 Maple Dr has been completed. 24 panels, estimated 14,200 kWh/yr...', date: '2026-06-15T16:30:00Z' },
    { id: 'm4', from: 'inspections@denver.example', subject: 'Inspection Scheduled — Permit #2026-0882', snippet: 'Electrical inspection confirmed for June 19th, 2026 between 9:00 AM and 12:00 PM...', date: '2026-06-15T14:22:00Z' },
    ...
    { id: 'm6', from: 'accounting@teslaenergy.example', subject: 'Invoice #TE-2026-4821 — Powerwall Order', snippet: '2x Tesla Powerwall 2 units shipped. Expected delivery: June 18. Tracking: 1Z999AA10...', date: '2026-06-14T15:45:00Z' },
    ...
    { id: 'm8', from: 'support@vendor.example', subject: 'RMA Approved — IQ8+ Microinverter', snippet: 'Replacement unit shipping today via FedEx 2-Day. Please return defective unit within 30 days...', date: '2026-06-13T13:12:00Z' },
  ],
};

export const DEMO_USERS = [
  { id: 'u1', name: 'Alex Rivera', email: 'alex@sunpeak-solar.example', role: 'owner' },
  { id: 'u2', name: 'Jake Morrison', email: 'jake@sunpeak-solar.example', role: 'admin' },
  { id: 'u3', name: 'Maria Santos', email: 'maria@sunpeak-solar.example', role: 'member' },
  { id: 'u4', name: 'Tyler Brooks', email: 'tyler@sunpeak-solar.example', role: 'member' },
  { id: 'u5', name: 'Priya Nair', email: 'priya@sunpeak-solar.example', role: 'member' },
  { id: 'u6', name: 'David Kim', email: 'david@sunpeak-solar.example', role: 'member' },
];
...
export const DEMO_CALENDAR = {
  ...
  calendarCount: 3,
  events: [
    { id: 'e1', title: 'Site Survey — Henderson (882 Maple Dr)', start: futureDate(0, 10, 0), end: futureDate(0, 11, 30), allDay: false, location: '882 Maple Dr, Denver CO', attendees: 2, owner: 'jake@sunpeak-solar.example' },
    { id: 'e2', title: 'Weekly Pipeline Review', start: futureDate(0, 14, 0), end: futureDate(0, 14, 45), allDay: false, location: 'Zoom', attendees: 5, owner: 'alex@sunpeak-solar.example' },
    { id: 'e3', title: 'Utility Call — Oncor Permits Dept', start: futureDate(1, 9, 0), end: futureDate(1, 9, 30), allDay: false, location: undefined, attendees: 1, owner: 'priya@sunpeak-solar.example' },
    { id: 'e4', title: 'Installation — Rodriguez Family', start: futureDate(1, 8, 0), end: futureDate(1, 16, 0), allDay: false, location: '4521 Oak Lane, Austin TX', attendees: 3, owner: 'tyler@sunpeak-solar.example' },
    { id: 'e5', title: 'AHJ Inspection — Park Residence', start: futureDate(2, 10, 0), end: futureDate(2, 12, 0), allDay: false, location: '2200 Pine Rd, Charlotte NC', attendees: 2, owner: 'jake@sunpeak-solar.example' },
    { id: 'e6', title: 'Customer Consultation — Mitchell', start: futureDate(2, 15, 0), end: futureDate(2, 16, 0), allDay: false, location: 'Google Meet', attendees: 2, owner: 'maria@sunpeak-solar.example' },
    { id: 'e7', title: 'SolarEdge Training Webinar', start: futureDate(3, 11, 0), end: futureDate(3, 12, 30), allDay: false, location: 'Zoom', attendees: 4, owner: 'alex@sunpeak-solar.example' },
