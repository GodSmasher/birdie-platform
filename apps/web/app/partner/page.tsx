    ...
    <div className="min-h-screen bg-[#fafaf9] text-[#1a1a1a]">
      ...
      <section id="contact" className="py-24 bg-[#1a1a1a] text-white text-center">
        <div className="max-w-2xl mx-auto px-6">
          ...
          <a href="mailto:hello@birdie.example?subject=Partnership" className="inline-flex px-8 py-4 bg-white text-[#1a1a1a] font-bold rounded-full text-[15px] hover:bg-white/90 transition-all">
            hello@birdie.example &rarr;
          </a>
        </div>
      </section>
