...
const NETZ_HAIKU_SYSTEM = `Du bist ein Email-Analyse-Bot für SunPeak Solar (Solarinstallateur).
...
export async function ingestEmail(email: IncomingEmail): Promise<IngestResult> {
  ...
  const autoReply = isCustomerMail && !email.from.includes('sunpeak-solar.example');
...
--
Netzanmeldung | SunPeak Solar
Tel.: +49 30 0000000
Mail: interconnection@sunpeak-solar.example
Web: sunpeak-solar.example
Hauptsitz: Musterstraße 1 | 10115 | Berlin`;
...
<table cellpadding="0" cellspacing="0" style="font-family: Arial, sans-serif; font-size: 13px; color: #333;">
  <tr>
    <td style="padding-right: 15px; border-right: 2px solid #c8d83c; vertical-align: top;">
      <img src="https://sunpeak-solar.example/logo.png" alt="SunPeak Solar" width="120" style="display: block;" />
    </td>
    <td style="padding-left: 15px; vertical-align: top;">
      <strong style="font-size: 14px;">Netzanmeldung</strong><br/>
      <span style="color: #666;">SunPeak Solar</span><br/><br/>
      <strong>Tel.:</strong> <a href="tel:+49300000000" style="color: #c8d83c; text-decoration: none;">+49 30 0000000</a><br/>
      <strong>Mail:</strong> <a href="mailto:interconnection@sunpeak-solar.example" style="color: #c8d83c; text-decoration: none;">interconnection@sunpeak-solar.example</a><br/>
      <strong>Web:</strong> <a href="https://sunpeak-solar.example" style="color: #c8d83c; text-decoration: none;">sunpeak-solar.example</a><br/>
      <strong>Hauptsitz:</strong> Musterstraße 1 | 10115 | Berlin
    </td>
  </tr>
</table>
</div>`;
