      ...
      <section id="contact" className="py-20 md:py-32 relative overflow-hidden">
        ...
        <R className="max-w-2xl mx-auto px-6 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-6">
            ...
            <a href="https://cal.example/birdie-intro" target="_blank" rel="noopener noreferrer" className="text-white/30 text-sm hover:text-white/50 transition">
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-10">
            <div className="col-span-2 md:col-span-1">
              ...
              <p className="text-[12px] text-white/15 mt-3">hello@birdie.example</p>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="flex flex-col gap-2.5 text-[13px] text-white/20">
                ...
                <a href="mailto:hello@birdie.example" className="hover:text-white/40 transition">Contact</a>
              </div>
            </div>
            <div>
