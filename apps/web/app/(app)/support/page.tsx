    ...
    return (
      <>
        ...
        <main className="flex-1 min-w-0 flex flex-col bg-bg">
          ...
          <DemoView message="Need help? Reach us at hello@birdie.example — no ticket queues. We handle connector setup, custom bots, and everything in between. Response time: under 24 hours." pose="wave">
