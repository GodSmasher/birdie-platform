...
const t = {
  en: {
    ...
    contact: 'Email hello@birdie.example',
  ...
  de: {
    ...
    contact: 'E-Mail an hello@birdie.example',
      ...
      <div className="flex-1 flex items-center justify-center bg-bg p-6">
        <div className="w-full max-w-[420px] flex flex-col gap-7 px-2 lg:px-10 py-10">
          ...
          <div className="flex flex-col items-center gap-1.5 mt-2">
            ...
            <Link href="mailto:hello@birdie.example" className="text-xs font-medium text-accent">
              {l.contact}
            </Link>
          </div>
        </div>
