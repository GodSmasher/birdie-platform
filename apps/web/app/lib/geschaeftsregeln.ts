...
// They are NOT in Reonic — they are installer company policy.
//
// CONFIRMED on 2026-05-26 by the pilot installer:
...
// The installer installs for self-consumption → always surplus feed-in.
export function einspeiseart(_project: ProjectData): Einspeiseart {
  return 'ueberschuss';
}

// Installer: system always runs 3-phase → no threshold needed.
...
// Installer: always DC-coupled storage with rectifier.
