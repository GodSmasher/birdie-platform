...
// ════════════════════════════════════════════════════════
const BOOK_URL = 'https://cal.example/birdie-intro';
    ...
    { message: "Your company profile — name, region, industry. This data feeds into documents, emails, and customer-facing materials.", content: (
      <Card className="p-5 flex flex-col gap-4">
        ...
        <div className="grid grid-cols-2 gap-3 text-xs">
          {[['Company','SunPeak Solar Systems'],['Industry','Solar'],['Region','Austin, TX (US)'],['Language','English']].map(([k,v]) => (
...
export function SupportGuide() {
  return <GuideStepper title="Support" welcomeMessage="Need help? You get a direct line to us — no ticket queues, no hold music. Connector setup, custom bots, data exports — just ask." ctaLabel="the team" ctaHref="mailto:hello@birdie.example" steps={[
    { message: "Reach out anytime — we handle connector setup, custom bots, and everything in between. Typical response: under 24 hours.", content: (
      <div className="grid grid-cols-2 gap-4">
        <Card className="g-slide p-5 flex flex-col gap-1.5" style={{ animationDelay: '0.3s' }}>
          ...
          <span className="text-sm font-medium text-fg">hello@birdie.example</span>
...
const SALES_DATA = [
  { name: 'Martinez Residence', size: '8.4 kW', value: '$32,500', stage: 'Proposal', rep: 'Jake', phone: '(480) 555-0142', email: 'tom.martinez@example.com', addr: '4521 E Camelback Rd, Phoenix AZ', panels: '21× REC Alpha Pure-R 400W', inverter: 'SolarEdge SE7600H', notes: 'Wants battery add-on. Follow up next week on financing options.' },
  { name: 'Johnson Commercial', size: '45 kW', value: '$128,000', stage: 'Negotiation', rep: 'Sarah', phone: '(602) 555-0398', email: 'l.johnson@johnsoncorp.example', addr: '8900 N Central Ave, Phoenix AZ', panels: '112× Canadian Solar 400W', inverter: '2× SMA Sunny Tripower 25kW', notes: 'Parking lot carport install. Need structural engineer sign-off.' },
  { name: 'Williams Home', size: '6.2 kW', value: '$24,800', stage: 'New Lead', rep: 'Mike', phone: '(520) 555-0276', email: 'williams.j@example.com', addr: '1120 S Mill Ave, Tempe AZ', panels: '16× Q.CELLS Q.PEAK DUO 390W', inverter: 'Enphase IQ8+', notes: 'Inbound from website. Scheduled site survey for next Tuesday.' },
  { name: 'Chen Duplex', size: '12.6 kW', value: '$48,200', stage: 'Won', rep: 'Sarah', phone: '(480) 555-0815', email: 'david.chen@example.com', addr: '2340 W Baseline Rd, Mesa AZ', panels: '32× REC Alpha Pure-R 400W', inverter: 'SolarEdge SE10000H', notes: 'Contract signed. Install scheduled for next month. Net metering approved.' },
  { name: 'Davis Property', size: '9.8 kW', value: '$38,400', stage: 'Survey', rep: 'Jake', phone: '(623) 555-0461', email: 'rdavis@example.com', addr: '6780 W Glendale Ave, Glendale AZ', panels: '25× LG Neon H 395W', inverter: 'SolarEdge SE10000H', notes: 'Roof needs inspection. Possible tile replacement before install.' },
];
